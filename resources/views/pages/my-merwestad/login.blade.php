...
{{--                </div>--}}
                ...
                <div class="mt-6">
                    <form action="{{ route('my-merwestad.login') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                <input type="email" name="email" id="email"
                                       ...
                                       placeholder="you@example.com" value="{{ old('email') }}" aria-invalid="true"
                        ...
                        <div>
                            <button type="submit"
                                    class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400">Sign in</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div class="hidden lg:block relative w-0 flex-1">
        <img class="absolute inset-0 h-full w-full object-cover" src="{{ url('assets/17973663_1910152352590432_7847193252022121877_o.jpeg') }}" alt="">
    </div>
</div>
@endsection
