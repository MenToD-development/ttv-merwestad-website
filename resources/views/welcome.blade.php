      ...
      <div class="w-full">
        ...
        <div class="flex flex-col lg:flex-row lg:items-stretch">
          <div class="w-full lg:w-2/4 xl:w-1/3 p-3">
            <div class="bg-white w-auto h-full overflow-y-hidden p-6 relative shadow">
              ...
              <span class="block text-primary-normal text-opacity-75 text-xs md:text-sm font-sans
              mb-6">
                Stefan de Jong -
                {{ \Illuminate\Support\Carbon::make('12-05-2020 21:15:06')->diffForHumans() }}
              </span>
              <div class="h-64 min-h-full mb-6">
          ...
          <div class="w-full lg:w-2/4 xl:w-2/3 p-3">
            <div class="bg-white p-6 w-full mb-6 shadow">
              <span class="text-black text-lg md:text-xl font-serif block">
                Gemeentelijke binnensportaccomodaties gesloten t/m 31-08-2020
              </span>
              <span class="block text-primary-normal text-opacity-75 text-xs md:text-sm font-sans
              mb-6">
                Kirsten Bubbert -
                {{ \Illuminate\Support\Carbon::make('13-05-2020 10:08:51')->diffForHumans() }}
              </span>
              <p class="inline-block font-sans text-base text-black mb-4">
            ...
            <div class="bg-white p-6 w-full shadow">
              <span class="text-black text-lg md:text-xl font-serif block">
                Gemeentelijke binnensportaccomodaties gesloten t/m 31-08-2020
              </span>
              <span class="block text-primary-normal text-opacity-75 text-xs md:text-sm font-sans
        ...
        <div class="flex justify-center mt-10">
          ...
          justify-center px-4 rounded"
            ...
            <span class="inline-block font-sans font-bold text-md md:text-lg text-white">Bekijk
              meer nieuws</span>
          </a>
        </div>
      </div>
  ...
  <div class="bg-white w-full py-16 md:py-24 xl:py-32">
    <div class="container mx-auto px-4 xl:px-8">
      ...
      <div class="flex flex-col lg:flex-row lg:justify-start lg:items-stretch w-full mb-16">
        <div class="w-full lg:w-2/3 py-4 px-6">
        ...
        <div class="w-full lg:w-1/3 py-4 px-6 flex items-end">
