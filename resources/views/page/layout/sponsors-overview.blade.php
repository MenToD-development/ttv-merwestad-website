    ...
    <div class="flex flex-col lg:flex-row lg:justify-start lg:items-stretch w-full mb-16">
      <div class="w-full lg:w-2/3 py-4 px-3 lg:px-6">
        ...
        <p class="text-base font-sans mb-6">
          ...
          <a href="http://www.rvbouwbedrijf.nl" target="_blank" title="Aannemer Dordrecht - Aannemersbedrijf, Bouwbedrijf &amp; Timmerbedrijf" class="bg-primary-normal hover:bg-primary-hover h-10 xl:h-12 inline-flex items-center
