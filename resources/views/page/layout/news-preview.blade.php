      ...
      <div class="flex flex-col lg:flex-row lg:items-stretch">
        <div class="w-full lg:w-2/4 xl:w-1/3 p-3">
          <div class="bg-white w-auto h-full overflow-y-hidden p-6 relative shadow">
            ...
            <span class="block text-primary-normal text-opacity-75 text-xs md:text-sm font-sans mb-6">
              Stefan de Jong - 2 maanden geleden
            </span>
            <div class="h-64 min-h-full mb-6 prose">
              <p>
              ...
              <p>
                <strong>
                  Graag hoor ik wie of welke teams competitie willen spelen.
                </strong></p>
              <p>
        ...
        <div class="w-full lg:w-2/4 xl:w-2/3 p-3">
          <div class="bg-white p-6 w-full mb-6 shadow">
            ...
            <span class="block text-primary-normal text-opacity-75 text-xs md:text-sm font-sans mb-6">
              Kirsten Bubbert - 2 maanden geleden
            </span>
